          ...
          {stats.scheduleRankings.length === 0 ? (
            ...
            stats.scheduleRankings.map((schedule) => (
              <div 
                ...
                className="border border-gray-200 rounded-lg p-6 cursor-pointer hover:border-blue-300 hover:shadow-lg transition-all duration-200 bg-white"
              ...
              >
                ...
                <div className="space-y-3 mb-4">
                  <div className="flex items-center gap-2">
                    <span className="text-sm font-medium text-gray-600 w-20">검색어:</span>
                    <span className="text-sm text-gray-900 font-medium">"{schedule.search_query}"</span>
                  </div>
                  
                  {schedule.target_product_name && (
                    <div className="flex items-center gap-2">
                      <span className="text-sm font-medium text-gray-600 w-20">대상 상품:</span>
                      <span className="text-sm text-gray-900 font-medium">"{schedule.target_product_name}"</span>
                    </div>
                  )}
                  
                  {schedule.target_mall_name && (
                    <div className="flex items-center gap-2">
                      <span className="text-sm font-medium text-gray-600 w-20">대상 쇼핑몰:</span>
                      <span className="text-sm text-gray-900 font-medium">"{schedule.target_mall_name}"</span>
                    </div>
                  )}
                </div>
                    ...
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-3">
                        <div className={`w-10 h-10 rounded-full flex items-center justify-center text-lg font-bold ${
                          schedule.rankings[0].total_rank <= 10 ? 'bg-red-100 text-red-600' :
                          schedule.rankings[0].total_rank <= 50 ? 'bg-orange-100 text-orange-600' :
      ...
      {selectedSchedule && (
        ...
        >
          <motion.div
            ...
            className="bg-white rounded-xl p-6 w-full max-w-6xl max-h-[90vh] overflow-y-auto shadow-2xl relative border border-gray-200"
