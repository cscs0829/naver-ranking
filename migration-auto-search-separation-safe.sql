-- 자동 검색과 순위 검색 분리를 위한 안전한 마이그레이션
-- 이 SQL을 Supabase SQL Editor에서 실행하세요

-- =============================================
-- 1. 자동 검색 설정 테이블 생성 (이미 있으면 스킵)
-- =============================================
...
-- =============================================
-- 5. auto_search_logs 테이블에 config_id 컬럼 추가
-- =============================================
